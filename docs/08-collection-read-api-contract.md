...
RC-1: 2026-07-23 — **API·격리 DB** `picknext_write_rc` Write Smoke **40/40**.
RC-2: 2026-07-23 — 브라우저 수동 QA 완료 (RC Backend `:8001` · Frontend `:5175`) · **RC-2-A PASS** · 기본 쓰기 Release Candidate **PASS**.
