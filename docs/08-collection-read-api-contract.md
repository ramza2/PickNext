...
> **비범위:** Collection 상세 Item 「제거」 빠른 연결 해제, Index 추가
...
I-2: 2026-07-23 — Item 수정 Dialog에서 Collection 연결·이동·해제 가능. Collection 상세 행 「제거」는 아직 미구현. PATCH로 빈 Collection이 되어도 유지.
