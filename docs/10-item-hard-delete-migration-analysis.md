...
**상태:** Migration·읽기 경로 전환 완료  
**D-2 완료일:** 2026-07-22  
**작성 기준일:** 2026-07-22  
**연계:** `docs/09-write-api-contract-analysis.md`  
**비범위 (잔여):** Item·Collection DELETE API, History 동반 삭제, Frontend 쓰기 (D-3~)
...
- DELETE API / History 동반 삭제 / Collection 자동 삭제 / Collection 409: **미구현 (D-3~)**
- FK ON DELETE 정책: Migration에서 변경 없음 (RESTRICT 유지)

### D-3 대기

Item Hard Delete API + RecommendationHistory 전체 선삭제 Transaction
