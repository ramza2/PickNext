...
**상태:** Migration·삭제·쓰기 Backend/Frontend · RC-1 API·격리 DB 검증 완료 · 브라우저 수동 QA 대기 (PASS WITH NOTES)
**D-2 완료일:** 2026-07-22  
...
**비범위 (잔여):** 브라우저 수동 QA, Bulk Delete, Drag & Drop, Category CRUD, History UI, TMDB, 인증
...
- **브라우저 수동 QA: 대기(미수행)** — Desktop/Mobile·Console·Network 미검증
- **판정: PASS WITH NOTES** (브라우저 미수행 상태에서 PASS 승격 없음)
