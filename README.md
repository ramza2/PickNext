...
│  ├─ tests/
│  └─ pyproject.toml
├─ frontend/          # Figma 기준선 + 홈 읽기 API 연동, 목록·상세는 Mock
...
- Frontend 홈 읽기 API 연동 완료, 전체 항목·상세는 Mock 유지

## 이번 범위에서 제외

- Frontend 전체 항목·상세 읽기 API 연동 (Phase B-2b~)
- 인증·로그인
...
1. Frontend Phase B-2b 전체 항목 목록 API 연동 (`docs/06-frontend-integration-plan.md`)
